...
class ReplyStrategy(ABC):
    ...
    def __init__(
        self,
        message_template: Optional[Union[str, Callable[[Update, ContextTypes.DEFAULT_TYPE], str]]] = None,
        parse_mode: Optional[str] = None,
        keyboard: Optional[Union[InlineKeyboardMarkup, Callable[[Update, ContextTypes.DEFAULT_TYPE], InlineKeyboardMarkup]]] = None
    ):
        self.message_template = message_template
        self.parse_mode = parse_mode
        self.keyboard = keyboard

    async def _send_message(self, update, context, message, keyboard):
