...
class LoggingErrorStrategy(ErrorStrategy):
    ...
    def __init__(self, notify_user: bool = True, default_message: str = "An error occurred while processing your request. Please try again later.", error_messages: Optional[dict[type[Exception], str]] = None):
